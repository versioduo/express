...
V2DEVICE_METADATA("com.versioduo.express", 17, "versioduo:samd:express");

constexpr static uint8_t n_potis = 16;
...
private:
  ...
  V2Potentiometer _potis[n_potis]{
